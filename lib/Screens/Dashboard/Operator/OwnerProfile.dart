                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder:(BuildContext)=>MyVehicalOperator("do")));
                            },
                            child: Container(
                              height: 40,
                              width: 100,
                              ...
                              child: Center(
                                child:Text("Vehicle",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.w600),),
                              ),
                            ),
                          )
                        ],
