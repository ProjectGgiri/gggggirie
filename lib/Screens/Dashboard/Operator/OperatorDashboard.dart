...
import 'package:ggiri/Screens/Dashboard/Owner/Dashboard/OwnerHome.dart';
import 'package:ggiri/Screens/Dashboard/Owner/Dashboard/OwnerProfile.dart';
import 'package:ggiri/Screens/Dashboard/Owner/Dashboard/Profile.dart';
class OperatorDashboard extends StatefulWidget {
  String status;


  OperatorDashboard(this.status);
...
class _OperatorDashboardState extends State<OperatorDashboard> {
  int pageindex=0;
  List<Widget> rscreen=[OwnerProfile() ,OperatorHome("do"),FeedbackScreen()];
  @override
