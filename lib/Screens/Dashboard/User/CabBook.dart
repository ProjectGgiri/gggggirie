...
class CabBookScreen extends StatefulWidget {
  ...
  @override
  State<CabBookScreen > createState() => _CabBookScreenState();
}

class _CabBookScreenState extends State<CabBookScreen > {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10,),
                  Text("Work District",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.w700),),
                  SizedBox(height: 10,),
                  ...
                  SizedBox(height: 10,),
                  Text("Location From",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.w700),),
                  SizedBox(height: 10,),
                  Container(
                    height: 50,
                    width: MediaQuery.of(context).size.width,
                  ...
                  SizedBox(height: 10,),
                  Text("Location To",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.w700),),
                  SizedBox(height: 10,),
                  Container(
                    height: 50,
                    width: MediaQuery.of(context).size.width,
