...
class SelectAgri extends StatefulWidget {
  ...
  @override
  State< SelectAgri  > createState() => _SelectAgriState();
}

class _SelectAgriState extends State< SelectAgri  > {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text("Vehicle Make Year",style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w700),),
                      SizedBox(height: 10,),
                      Container(
                        height: 50,
                        width: 150,
