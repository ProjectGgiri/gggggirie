...
class InProgressCard extends StatefulWidget {
  const InProgressCard({Key? key}) : super(key: key);
        ...
        children: [
                     ...
                     Row(
                       ...
                       children: [
                         ...
                         Container(height: 40,width: 80,decoration: BoxDecoration(
                           ...
                           color: Color(0xffFFDA92),
                         ),child: Center(child:  Text("₹ 2000/ Day",maxLines: 1,style: TextStyle(color: Colors.black,fontSize: 11,fontWeight: FontWeight.w700),),)),
                       ],
                     )
                   ],
                 ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(height: 20,width: 80,decoration: BoxDecoration(
                            borderRadius: BorderRadius.all(Radius.circular(20)),
                            border:  Border.all(color: Colors.black,width: 2)
                        ),child: Center(child:  Text("View More",maxLines: 1,style: TextStyle(color:Colors.black,fontSize: 11,fontWeight: FontWeight.w600),),)),
          ...
          Container(
           ...
           child: Container(height: 50,width: 150,
             ...
             ),child: Center(child: Text('CLICK TO MARK COMPLETED',style: TextStyle(color: Colors.white,fontSize: 13,fontWeight: FontWeight.w600),),),),
