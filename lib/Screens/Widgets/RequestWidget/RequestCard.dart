          ...
          Container(
           ...
           child: Row(
             children: [
               ...
               ),child: Center(child: Text('EDIT',style: TextStyle(color: Colors.white,fontSize: 13,fontWeight: FontWeight.w600),),),),
               Container(height: 50,width: 170,
                 decoration: BoxDecoration(
                   color: Color(0xffF3F3F3),

                 ),child: Center(child: Text('DELETE',style: TextStyle(color: Colors.red,fontSize: 13,fontWeight: FontWeight.w600),),),)
             ],
           ),
