...
class CompactorBooing extends StatefulWidget {
  String img,com,model,price,type;


  CompactorBooing(this.img, this.com, this.model, this.price,this.type);

  @override
  State<CompactorBooing> createState() => _CompactorBooingState();
}

class _CompactorBooingState extends State<CompactorBooing > {
      ...
      child: Scaffold(
        body: ListView(
          children: [
            ...
            Center(child: Text(widget.model,style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.w600),),),)
              ,),
            SizedBox(height: 10,),
            Padding(
