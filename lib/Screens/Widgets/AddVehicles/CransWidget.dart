...
class CraneWidget extends StatefulWidget {
  String img,com,model,price,type,tyre,feet,status;

  CraneWidget(this.img, this.com, this.model, this.price, this.type,this.tyre,this.feet,this.status);

  @override
  State<CraneWidget> createState() => _CraneWidgetState();
}

class _CraneWidgetState extends State<CraneWidget> {
  @override
