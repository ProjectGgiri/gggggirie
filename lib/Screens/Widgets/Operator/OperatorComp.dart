...
class OpeCompletedCard extends StatefulWidget {
  const OpeCompletedCard ({Key? key}) : super(key: key);

  @override
  State<OpeCompletedCard > createState() => _OpeCompletedCardState();
}

class _OpeCompletedCardState extends State<OpeCompletedCard > {
  @override
