...
class OperatorRequestCard extends StatefulWidget {
  const OperatorRequestCard({Key? key}) : super(key: key);

  @override
  State<OperatorRequestCard> createState() => _OperatorRequestCardState();
}

class _OperatorRequestCardState extends State<OperatorRequestCard> {
  @override
                ...
                child: Row(
                  ...
                  children: [Row(
                    ...
                    children: [Text('Status :',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w900),),
                      Text('OPEN',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w900),)],
                  ),Spacer(),Row(
                    mainAxisAlignment: MainAxisAlignment.start,
