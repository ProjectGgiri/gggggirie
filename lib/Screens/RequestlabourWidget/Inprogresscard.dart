...
class LInProgressCard extends StatefulWidget {
  Map data;


  LInProgressCard(this.data);

  @override
  State<LInProgressCard > createState() => _LInProgressCardState();
}

class _LInProgressCardState extends State<LInProgressCard > {
  @override
             ...
             child: Padding(
               ...
               child: Row(
                 ...
                 children: [Row(
                   ...
                   mainAxisAlignment: MainAxisAlignment.start,
                   children: [Text('WID:'+widget.data["wid"],style: TextStyle(color: Colors.white,overflow: TextOverflow.ellipsis,fontSize: 12,fontWeight: FontWeight.w900),),
                     SizedBox(width: 10,),
