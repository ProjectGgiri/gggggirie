...
class LabourProfileinfo extends StatefulWidget {
  String status;


  LabourProfileinfo(this.status);

  @override
  State<LabourProfileinfo> createState() => _LabourProfileinfoState();
}

class _LabourProfileinfoState extends State<LabourProfileinfo> {
